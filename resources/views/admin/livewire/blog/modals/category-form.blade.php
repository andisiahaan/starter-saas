<div class="bg-white dark:bg-dark-elevated rounded-lg p-2 md:p-6 w-full">
    <div class="flex items-center justify-between mb-6">
        <h3 class="text-lg font-semibold text-slate-900 dark:text-white">{{ $categoryId ? 'Edit Category' : 'Add Category' }}</h3>
    ...
    <form wire:submit="save" class="space-y-4">
        ...
        <div>
            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">Parent Category</label>
        ...
        <div class="flex items-center gap-4">
            <div>
                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">Order</label>
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-slate-200 dark:border-dark-border">
            <button type="button" wire:click="$dispatch('closeModal')" class="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-dark-border rounded-lg transition">Cancel</button>
            <button type="submit" class="px-4 py-2 bg-primary-600 text-white text-sm font-medium rounded-lg hover:bg-primary-700 transition">{{ $categoryId ? 'Update' : 'Create' }}</button>
        </div>
    </form>
</div>
