<div>
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white"><?php echo e(__('blog.posts.title')); ?></h1>
            <p class="text-sm text-slate-500 dark:text-slate-400"><?php echo e(__('blog.posts.description')); ?></p>
        </div>
    ...
    <div class="flex flex-col sm:flex-row gap-4 mb-6">
        <input type="text" wire:model.live.debounce.300ms="search" placeholder="<?php echo e(__('blog.posts.filters.search')); ?>" class="flex-1 max-w-md rounded-lg border-slate-300 dark:border-dark-border bg-white dark:bg-dark-elevated text-slate-900 dark:text-white focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
        <select wire:model.live="status" class="rounded-lg border-slate-300 dark:border-dark-border bg-white dark:bg-dark-elevated text-slate-900 dark:text-white focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
            <option value=""><?php echo e(__('blog.posts.filters.all_status')); ?></option>
            <option value="draft"><?php echo e(__('blog.posts.status.draft')); ?></option>
            <option value="published"><?php echo e(__('blog.posts.status.published')); ?></option>
            <option value="scheduled"><?php echo e(__('blog.posts.status.scheduled')); ?></option>
            <option value="archived"><?php echo e(__('blog.posts.status.archived')); ?></option>
        </select>
    </div>
    ...
    <div class="bg-white dark:bg-dark-elevated rounded-lg border border-slate-200 dark:border-dark-border overflow-hidden">
        <table class="min-w-full divide-y divide-slate-200 dark:divide-dark-border">
            <thead class="bg-slate-50 dark:bg-dark-soft">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider"><?php echo e(__('blog.posts.table.post')); ?></th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider"><?php echo e(__('blog.posts.table.author')); ?></th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider"><?php echo e(__('blog.posts.table.categories')); ?></th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider"><?php echo e(__('blog.posts.table.status')); ?></th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider"><?php echo e(__('blog.posts.table.views')); ?></th>
                    <th class="px-6 py-3 text-right text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider"><?php echo e(__('common.table.actions')); ?></th>
                </tr>
            </thead>
            <tbody class="divide-y divide-slate-200 dark:divide-dark-border">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-dark-soft transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400">
                        <?php echo e($post->author->name ?? __('common.unknown')); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <span class="px-2 py-1 text-xs font-medium rounded-full <?php echo e($statusColors[$post->status] ?? ''); ?>">
                            <?php echo e(__('blog.posts.status.' . $post->status)); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="<?php echo e(route('admin.blog.posts.edit', $post)); ?>" class="text-primary-600 hover:text-primary-900 dark:text-primary-400 dark:hover:text-primary-300 mr-3"><?php echo e(__('common.actions.edit')); ?></a>
                        <button wire:click="delete(<?php echo e($post->id); ?>)" wire:confirm="<?php echo e(__('common.confirm.delete')); ?>" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300"><?php echo e(__('common.actions.delete')); ?></button>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-slate-500 dark:text-slate-400">
                        ...
                        <p><?php echo e(__('blog.posts.empty')); ?> <a href="<?php echo e(route('admin.blog.posts.create')); ?>" class="text-primary-600 hover:underline"><?php echo e(__('blog.posts.create_first')); ?></a></p>
                    </td>
                </tr>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </tbody>
