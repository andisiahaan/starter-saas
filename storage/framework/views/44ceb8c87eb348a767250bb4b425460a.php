...
<!-- Sidebar -->
<aside x-data="{ activeMenu: '<?php echo e(request()->routeIs('app.index') ? 'dashboard' : ''); ?>' }"
    ...
    <div class="flex items-center h-16 px-4 border-b border-slate-200 dark:border-dark-border shrink-0">
        <a href="<?php echo e(route('app.index')); ?>" class="flex items-center gap-2">
    ...
    <nav class="flex-1 overflow-y-auto custom-scrollbar px-3 py-4 space-y-1">
        ...
        <a href="<?php echo e(route('app.index')); ?>"
            class="sidebar-link <?php echo e(request()->routeIs('app.index') ? 'sidebar-link-active' : 'sidebar-link-default'); ?>">
        ...
        <div class="pt-4">
            ...
            <!-- API Docs -->
            <a href="<?php echo e(route('docs.api')); ?>"
...
</aside><?php /**PATH D:\Installed\Apps\laragon\www\starter\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>