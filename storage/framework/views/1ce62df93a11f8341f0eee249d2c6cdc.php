<div class="p-6">
    <div class="max-w-xl">
        <h3 class="text-lg font-medium text-slate-900 dark:text-white"><?php echo e(__('account.two_factor.title')); ?></h3>
        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400"><?php echo e(__('account.two_factor.description')); ?></p>
        ...
        <div class="mt-6">
            ...
            <div class="p-4 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-medium text-emerald-800 dark:text-emerald-200"><?php echo e(__('account.two_factor.enabled')); ?></p>
                        <p class="text-sm text-emerald-600 dark:text-emerald-400"><?php echo e(__('account.two_factor.recovery_remaining', ['count' => $recoveryCodesCount])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-4 flex flex-wrap gap-3">
                <button wire:click="$dispatch('openModal', { component: 'app.account.modals.show-recovery-codes-modal' })" class="btn btn-outline">
                    <?php echo e(__('account.two_factor.view_codes')); ?>

                </button>
                <button wire:click="regenerateRecoveryCodes" class="btn btn-ghost">
                    <?php echo e(__('account.two_factor.regenerate_codes')); ?>
                ...
                <button wire:click="$dispatch('openModal', { component: 'app.account.modals.disable-two-factor-modal' })" class="btn btn-ghost text-red-600 hover:text-red-700 dark:text-red-400">
                    <?php echo e(__('account.two_factor.disable')); ?>
            ...
            <div class="p-4 bg-slate-50 dark:bg-dark-soft border border-slate-200 dark:border-dark-border rounded-lg">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-medium text-slate-900 dark:text-white"><?php echo e(__('account.two_factor.not_enabled')); ?></p>
                        <p class="text-sm text-slate-500 dark:text-slate-400"><?php echo e(__('account.two_factor.enable_hint')); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-4">
                <button wire:click="$dispatch('openModal', { component: 'app.account.modals.enable-two-factor-modal' })" class="btn btn-primary">
                    <?php echo e(__('account.two_factor.enable')); ?>
        ...
        <div class="mt-6 p-4 bg-sky-50 dark:bg-sky-900/20 border border-sky-200 dark:border-sky-800 rounded-lg">
            <div class="flex gap-3">
                ...
                <div class="text-sm text-sky-800 dark:text-sky-200">
                    <p class="font-medium"><?php echo e(__('account.two_factor.how_it_works')); ?></p>
                    <p class="mt-1 text-sky-600 dark:text-sky-400"><?php echo e(__('account.two_factor.explanation')); ?></p>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH D:\Installed\Apps\laragon\www\starter\resources\views/livewire/app/account/two-factor-auth.blade.php ENDPATH**/ ?>