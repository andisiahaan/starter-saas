...
<?php $component = App\View\Components\Layouts\Main::resolve(['title' => 'Tag: ' . $tag->name . ' - Blog'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white mt-4">#<?php echo e($tag->name); ?></h1>
            ...
            <p class="text-slate-600 dark:text-slate-400 mt-2"><?php echo e($tag->description); ?></p>
...
<?php endif; ?>
<?php /**PATH D:\Installed\Apps\laragon\www\starter\resources\views/blog/tag.blade.php ENDPATH**/ ?>