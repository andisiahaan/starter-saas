        ...
        <div class="flex items-start gap-4">
            ...
            <div>
                <p class="text-slate-700 dark:text-slate-300">
                    Are you sure you want to delete <strong class="text-slate-900 dark:text-white"><?php echo e($user?->name); ?></strong>?
                </p>
...
<?php /**PATH D:\Installed\Apps\laragon\www\starter\resources\views/admin/livewire/users/modals/delete-user-modal.blade.php ENDPATH**/ ?>