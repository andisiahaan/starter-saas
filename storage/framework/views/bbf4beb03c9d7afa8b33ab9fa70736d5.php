...
<aside :class="{ 'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen }"
    ...
    <div class="flex items-center h-16 px-4 bg-slate-50 dark:bg-dark-soft border-b border-slate-200 dark:border-dark-border shrink-0">
        <a href="<?php echo e(route('admin.index')); ?>" class="flex items-center gap-2">
            ...
            <span class="text-lg font-bold text-slate-900 dark:text-white"><?php echo e(__('admin.sidebar.admin_panel')); ?></span>
        </a>
    ...
    <nav class="flex-1 overflow-y-auto custom-scrollbar px-3 py-4 space-y-1">
        ...
        <div class="pt-4">
            <p class="px-3 mb-2 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                <?php echo e(__('admin.sidebar.management')); ?>
            ...
            <div x-data="{ open: <?php echo e(request()->routeIs('admin.users.*') ? 'true' : 'false'); ?> }">
                <button @click="open = !open"
                    class="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.users.*') ? 'text-primary-600 dark:text-primary-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <span class="flex-1 text-left"><?php echo e(__('admin.sidebar.users')); ?></span>
            ...
            <div x-data="{ open: <?php echo e((request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*')) ? 'true' : 'false'); ?> }">
                <button @click="open = !open"
                    class="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.roles.*') ? 'text-primary-600 dark:text-primary-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                    <span class="flex-1 text-left"><?php echo e(__('admin.sidebar.permissions')); ?></span>
                    <svg class="w-4 h-4 transition-transform" :class="{ 'rotate-180': open }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
                ...
                <div x-show="open" x-collapse class="mt-1 ml-4 pl-4 border-l border-slate-200 dark:border-dark-border space-y-1">
                    <a href="<?php echo e(route('admin.roles.index')); ?>"
                        ...
                        <?php echo e(__('admin.roles.title')); ?>
                ...
                <div x-show="open" x-collapse class="mt-1 ml-4 pl-4 border-l border-slate-200 dark:border-dark-border space-y-1">
                    <a href="<?php echo e(route('admin.permissions.index')); ?>"
                        ...
                        <?php echo e(__('admin.sidebar.permissions')); ?>
        ...
        <div class="pt-4">
            <p class="px-3 mb-2 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                <?php echo e(__('admin.sidebar.credit_system')); ?>

            </p>

            <!-- Products -->
            <a href="<?php echo e(route('admin.products.index')); ?>"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.products.*') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 border-l-2 border-primary-500' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                </svg>
                <?php echo e(__('admin.sidebar.products')); ?>

            </a>

            <!-- Product Categories -->
            <a href="<?php echo e(route('admin.product-categories.index')); ?>"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.product-categories.*') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 border-l-2 border-primary-500' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                </svg>
                <?php echo e(__('admin.sidebar.categories')); ?>

            </a>

            <!-- Payment Methods -->
            <a href="<?php echo e(route('admin.payment-methods.index')); ?>"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.payment-methods.*') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 border-l-2 border-primary-500' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                </svg>
                <?php echo e(__('admin.sidebar.payment_methods')); ?>

            </a>

            <!-- Orders -->
            <a href="<?php echo e(route('admin.orders.index')); ?>"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 border-l-2 border-primary-500' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                </svg>
                <?php echo e(__('admin.sidebar.orders')); ?>

            </a>

            <!-- Credit Logs -->
            <a href="<?php echo e(route('admin.credit-logs.index')); ?>"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.credit-logs.*') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 border-l-2 border-primary-500' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <?php echo e(__('admin.sidebar.credit_logs')); ?>
        ...
        <div class="pt-4">
            <p class="px-3 mb-2 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                <?php echo e(__('admin.sidebar.content')); ?>
            ...
            <a href="<?php echo e(route('admin.pages.index')); ?>"
                ...
                <?php echo e(__('admin.sidebar.pages')); ?>
            ...
            <a href="<?php echo e(route('admin.news.index')); ?>"
                ...
                <?php echo e(__('admin.sidebar.news')); ?>

            </a>
            
            <!-- Blog (Collapsible) -->
            <div x-data="{ open: <?php echo e(request()->routeIs('admin.blog.*') ? 'true' : 'false'); ?> }">
                <button @click="open = !open" class="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.blog.*') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                    <span class="flex items-center gap-3">
                        ...
                        <?php echo e(__('admin.sidebar.blog')); ?>
                ...
                <div x-show="open" x-collapse class="mt-1 ml-4 space-y-1">
                    <a href="<?php echo e(route('admin.blog.posts.index')); ?>"
                        ...
                        <?php echo e(__('admin.sidebar.posts')); ?>
                    ...
                    <a href="<?php echo e(route('admin.blog.tags.index')); ?>"
                        ...
                        <?php echo e(__('admin.sidebar.tags')); ?>
        ...
        <div class="pt-4">
            <p class="px-3 mb-2 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                <?php echo e(__('admin.sidebar.support')); ?>
            ...
            <a href="<?php echo e(route('admin.tickets.index')); ?>"
                ...
                <?php echo e(__('admin.sidebar.tickets')); ?>
        ...
        <div class="pt-4">
            <p class="px-3 mb-2 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                <?php echo e(__('admin.sidebar.referral')); ?>
            ...
            <a href="<?php echo e(route('admin.referrals.index')); ?>"
                ...
                <?php echo e(__('admin.sidebar.referrals')); ?>

            </a>

            <!-- Commissions -->
            <a href="<?php echo e(route('admin.commissions.index')); ?>"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.commissions.index') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 border-l-2 border-primary-500' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <?php echo e(__('admin.sidebar.commissions')); ?>

            </a>

            <!-- Withdrawals -->
            <a href="<?php echo e(route('admin.withdrawals.index')); ?>"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.withdrawals.index') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 border-l-2 border-primary-500' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                <?php echo e(__('admin.sidebar.withdrawals')); ?>
        ...
        <div class="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 transition-colors cursor-pointer">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-slate-500 dark:text-slate-400 truncate">
                    <?php echo e(__('admin.sidebar.administrator')); ?>

                </p>
            </div>
        </div>
    </div>
</aside><?php /**PATH D:\Installed\Apps\laragon\www\starter\resources\views/admin/layouts/partials/sidebar.blade.php ENDPATH**/ ?>